...
public class EX3_13 {
	public static void main(String[] args) {
		...
		System.out.print("(0-Single filter, 1-married jointly or "+" qualifying  widow(er) ,2-married separately, 3-head of "+" household) Enter the filling status: ");
		...
		if(status==0) {
			...
			}else tax=8350 *0.1+(33950-8350)*0.15+(82250-33950)*0.25+(171550-82250)*0.28+(372950-171550)*0.33+(income-372950)*0.35;
		}else if(status==1) {
			if(income<=16700) {
				tax=income*0.1;
			...
			}else tax=16700 *0.1+(67900-16700)*0.15+(137050-67900)*0.25+(208850-137050)*0.28+(372950-208850)*0.33+(income-372950)*0.35;
		}else if(status==2) {
			if(income<=8350) {
				tax=income*0.1;
			}else if(income<=33950) {
				...
				tax=8350*0.1+(33950-33950)*0.15+(income-33950)*0.25;
			}else if(income<=104425) {
				tax=8350*0.1+(33950-33950)*0.15+(68525-33950)*0.25+(income-68525)*0.28;
			}else if(income<=186475) {
				tax=8350*0.1+(33950-33950)*0.15+(68525-33950)*0.25+(104425-68525)*0.28+(income-104425)*0.33;
			}else tax=8350*0.1+(33950-33950)*0.15+(68525-33950)*0.25+(104425-68525)*0.28+(186475-104425)*0.33+(income-186475)*0.35;
		}else if(status==3) {
			if(income<=11950) {
				tax=income*0.1;
